" Vim syntax file
" Language:	ere
" Maintainer:	Elein Mustain <elein@varlena.com>
" URL:		http://www.varlena.com/Reports/Docs/ere.vim
" Last Change:  2003 Jan 3
"""" 
"""" This file is simply the html vim syntax file with
"""" ere specific tags added.  There are only minor additions
"""" and they are labeled as such. 
"""" To install this as a new syntax file, add the ere suffix
"""" to your vim/filetype.vim file and copy this file 
"""" to the suffix directory.  Alternatively, you may
"""" want to merge and/or overwrite this file with your
"""" existing html syntax file.
"""" 
" Vim syntax file
" Language:     HTML
" Maintainer:   Claudio Fleiner <claudio@fleiner.com>
" URL:          http://www.fleiner.com/vim/syntax/ere.vim
...
" ere tags
syn keyword htmlTagName contained area breaklist datastreamdef 
syn keyword htmlTagName contained reportdefinition reportname sql targetlist 

" ere legal args NB: name, value also in below legal arg names
syn keyword htmlArg contained break checkbreak csv datastream maxrepeat
syn keyword htmlArg contained name value 
